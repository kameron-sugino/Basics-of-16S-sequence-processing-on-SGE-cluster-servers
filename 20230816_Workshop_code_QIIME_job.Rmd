...
* One other thing to note before we get into the code: I'm using the greengenes2 database for this run (https://forum.qiime2.org/t/introducing-greengenes2-2022-10/25291). It's required to get gene annotation predictions from Picrust2 (https://github.com/picrust/picrust2/wiki). 
